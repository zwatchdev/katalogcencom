...
const maxBannerImageBytes = 5 * 1024 * 1024;
...
function handleSiteBannerUpload(file) {
  ...
  if (file.size > maxBannerImageBytes) {
    Swal.fire({
      ...
      text: "Ukuran maksimal banner adalah 5MB.",
      icon: "warning",
      confirmButtonText: "Tutup",
      confirmButtonColor: "#ca1111"
    });
...
function duplicateProductToTargetCategory(productId, targetCategory) {
  const product = products.find((item) => item.id === productId);
  ...
  Swal.fire({
    title: normalizedTargetPriceMode === "Kredit" ? "Duplikat ke produk kredit" : "Duplikat ke produk cash",
    text: normalizedTargetPriceMode === "Kredit"
      ? "Data produk sudah disalin ke form. Tinggal ubah harga kredit lalu simpan."
      : "Data produk sudah disalin ke form. Tinggal ubah harga cash lalu simpan.",
    icon: "success",
